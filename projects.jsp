...
<body>
	<div class="wrapper wrapper--w1000">
		...
		<div class="card card-5">
			...
			<div class="card-body">
				<form method="POST">
					...
					<div class="form-row">
						<div class="name">Tên dự án con</div>
						<div class="value">
					...
					<div class="form-row">
						<div class="name">Miêu tả dự án con</div>
						<div class="value">
							<div class="input-group">
						...
						<div class="value">
							<div class="input-group js-input-file">
								<input class="input-file" type="file" name="file_project"
									...
									tệp tin</label> <span class="input-file__info">Không có tệp nào
									được chọn</span>
							</div>
		...
		<div class="card-footer">
			<a href='<c:url value = '/home/projects/edit'/>'><button
					class="btn btn--radius-2 btn--blue-2"
					style="background-color: #0047AB; color: #FFFFFF;" type="submit">
					Tạo dự án mới</button></a>
